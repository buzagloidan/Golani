...
echo "<li>Login with admin account: <strong>username:</strong> admin, <strong>password:</strong> admin123 (רס\"ן with 50,000₪)</li>";
echo "<li>Login with test account: <strong>username:</strong> test, <strong>password:</strong> test123 (סמל with 5,000₪)</li>";
